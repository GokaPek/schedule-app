        ...
        <div className="row">
          ...
          <div className="col-md-3">
            ...
            <ul className="list-unstyled">
              <li><a href="/schedule" className="text-decoration-none text-white">Расписание</a></li>
              <li><a href="/classrooms" className="text-decoration-none text-white">Аудитории</a></li>
            </ul>
          </div>
          <div className="col-md-3">
            <h5>Контакты</h5>
